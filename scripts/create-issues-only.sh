...
# GitHub Issues 作成スクリプト (マイルストーン番号指定)
# Usage: bash scripts/create-issues-only.sh

set -e

echo "🎫 GitHub Issues 作成開始..."

# マイルストーン名を設定
MILESTONE_1="Phase 1: MVP開発"
MILESTONE_2="Phase 2: 機能拡張"

echo "📌 Phase 1 マイルストーン: $MILESTONE_1"
echo "📌 Phase 2 マイルストーン: $MILESTONE_2"
